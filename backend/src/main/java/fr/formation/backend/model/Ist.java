...
public class Ist {
    ...
    public Ist(Integer id, String nom, int gravite, Integer incidence, String shortDescription, String longDescription,
            TypeIst typeIst, List<Symptome> symptomes, List<Transmission> transmissions, List<Prevention> preventions,
